...
public class DataTransferEditDialog extends JDialog{
	...
	public DataTransferEditDialog(JFrame owner, DataTransferPanel parent, Integer transferId) {
		// TODO Auto-generated constructor stub
		super(owner,"数据传输管理-编辑数据传输",true);
		this.owner = owner;
		...
		DataTransferVO dataTrasferVO = dao.getDataTransferVOById(transferId);
		if(dataTrasferVO != null) {
			deptNameField.setText(dataTrasferVO.getDeptName());
			mainIpAddressField.setText(dataTrasferVO.getMainIpAddress());
			mainPortField.setText(String.valueOf(dataTrasferVO.getMainPort()));
			mainUserNameField.setText(dataTrasferVO.getMainUserName());
			mainPasswordField.setText(dataTrasferVO.getMainPassword());
			mainDatabaNameField.setText(dataTrasferVO.getMainDatabaseName());
			backIpAddressField.setText(dataTrasferVO.getBackIpAddress());
			backPortField.setText(String.valueOf(dataTrasferVO.getBackPort()));
			backUserNameField.setText(dataTrasferVO.getBackUserName());
			backPasswordField.setText(dataTrasferVO.getBackPassword());
			backDatabaNameField.setText(dataTrasferVO.getBackDatabaseName());
		}
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(StringUtils.isEmpty(mainIpAddressField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入源库地址");
					return;
				}
				
				if(StringUtils.isEmpty(mainPortField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入源库端口号");
					return;
				}
				if(StringUtils.isEmpty(mainUserNameField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入源库用户名");
					return;
				}
				
				if(StringUtils.isEmpty(mainPasswordField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入源库密码");
					return;
				}
				
				if(StringUtils.isEmpty(mainDatabaNameField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入源库库名");
					return;
				}
				if(StringUtils.isEmpty(backIpAddressField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入目标库地址");
					return;
				}
				if(StringUtils.isEmpty(backPortField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入目标库端口号");
					return;
				}
				if(StringUtils.isEmpty(backUserNameField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入目标库用户名");
					return;
				}
				
				if(StringUtils.isEmpty(backPasswordField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入目标库密码");
					return;
				}
				
				if(StringUtils.isEmpty(backDatabaNameField.getText())){
					JOptionPane.showMessageDialog(DataTransferEditDialog.this, "请输入目标库库名");
					return;
				}
				...
				DataTransferDao dao = new DataTransferDao();
				dao.update(transferId, dataTransferVO);
				JOptionPane.showMessageDialog(DataTransferEditDialog.this, "修改数据传输成功","提示",JOptionPane.INFORMATION_MESSAGE);
				DataTransferEditDialog.this.dispose();
				parent.showTable();

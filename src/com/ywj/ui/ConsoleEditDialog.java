...
public class ConsoleEditDialog extends JDialog{
	...
	public ConsoleEditDialog(JFrame owner,ConsolePanel parent,int consoleId) {
		super(owner,"控制台管理-编辑控制台",true);
		this.owner = owner;
		JPanel inputPanel = new JPanel();
		inputPanel.setMinimumSize(new Dimension(300, 400));
		...
		Console console = dao.getConsoleById(consoleId);
		if(console != null) {
			nameField.setText(console.getName());
			innerurlField.setText(console.getInnerurl());
			outurlField.setText(console.getOuturl());
			loginName1Field.setText(console.getLoginName1());
			loginPassword1Field.setText(console.getLoginPassword1());
			loginName2Field.setText(console.getLoginName2());
			loginPassword2Field.setText(console.getLoginPassword2());
			webBrowserField.setText(console.getWebBrowser());
			innerUserTagNameField.setText(console.getInnerUserTagName());
			innerPasswordTagNameField.setText(console.getInnerPasswordTagName());
			outUserTagNameField.setText(console.getOutUserTagName());
			outPasswordTagNameField.setText(console.getOutPasswordTagName());
		}
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(StringUtils.isEmpty(nameField.getText())) {
					JOptionPane.showMessageDialog(ConsoleEditDialog.this, "请输入系统名称");
					return;
				}
				if(StringUtils.isEmpty(innerurlField.getText())){
					//JOptionPane.showMessageDialog(ConsoleEditDialog.this, "请输入内网地址");
					//return;
				}
				
				if(StringUtils.isEmpty(loginName1Field.getText())){
					//JOptionPane.showMessageDialog(ConsoleEditDialog.this, "请输入登录账户1");
					//return;
				}
				if(StringUtils.isEmpty(loginPassword1Field.getText())){
					//JOptionPane.showMessageDialog(ConsoleEditDialog.this, "请输入登录密码1");
					//return;
				}
				...
				dao.update(consoleId, console);
				JOptionPane.showMessageDialog(ConsoleEditDialog.this, "编辑控制台成功","提示",JOptionPane.INFORMATION_MESSAGE);
				ConsoleEditDialog.this.dispose();
				parent.showTable();
